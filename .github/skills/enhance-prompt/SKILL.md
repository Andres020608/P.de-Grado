...
1. **Be specific early** — Vague inputs need more enhancement work
2. **Consider the platform** — Mobile and desktop have different patterns
3. **Name colors descriptively** — "Deep Ocean Blue" not just "blue"
4. **Structure clearly** — Numbered sections help generation accuracy
5. **Check for existing design systems** — Consistency matters
