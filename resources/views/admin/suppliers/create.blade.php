<x-layouts.admin>
    <div class="max-w-2xl mx-auto bg-white rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200">
            <h1 class="text-2xl font-semibold text-gray-900">Crear Nuevo Proveedor</h1>
        </div>

        <form method="POST" action="{{ route('admin.suppliers.store') }}" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="primary_contact" id="primary_contact" value="{{ old('primary_contact') }}"
                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="space-y-3">
                <div class="flex items-center">
                    <input type="checkbox" name="rjc_certified" id="rjc_certified" value="1" {{ old('rjc_certified') ? 'checked' : '' }}
                           class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                    <label for="rjc_certified" class="ml-2 block text-sm text-gray-700">Certificado RJC</label>
                </div>

                <div class="flex items-center">
                    <input type="checkbox" name="carbon_neutral" id="carbon_neutral" value="1" {{ old('carbon_neutral') ? 'checked' : '' }}
                           class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                    <label for="carbon_neutral" class="ml-2 block text-sm text-gray-700">Carbono Neutral</label>
                </div>

                <div class="flex items-center">
                    <input type="checkbox" name="heritage_craft" id="heritage_craft" value="1" {{ old('heritage_craft') ? 'checked' : '' }}
                           class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
